...
namespace file_transfer
{
    ...
    public class TransferClient
    {
                ...
                case Headers.Queue:
                    {
                        ...
                        TransferQueue queue = TransferQueue.CreateDownloadQueure(this, id, Path.Combine(OutputFolder), Path.GetFileName(fileName), length); //////////5:30
        ...
        internal void callProcessChanged(TransferQueue queue)
        {
            if (ProgressChanged != null)
            {
                ProgressChanged(this, queue);
